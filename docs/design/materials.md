...
| **Sidebar** | Sunken vs canvas (`#0C0C0C` dark / zinc-100 light). Slight translucency on desktop only — **no** stacked CSS blur | Elevation from luminosity, not frost |
...
| `--chat-composer-outline` | white @ 14% | black @ 10% | Prompt box edge |
| `--menu-surface` | `#1c1c1c` | `#ffffff` | Agent/model menu, similar popovers |
| `--menu-border` | white @ 12% | black @ 12% | Menu edge |
| `--menu-row-hover` | `#2a2a2a` | black @ 5% | Row hover |
| `--menu-row-active` | `#313131` | black @ 7% | Selected / active row |
